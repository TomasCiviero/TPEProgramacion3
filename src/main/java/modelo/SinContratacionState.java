...
public class SinContratacionState implements IState{
    ...
    public boolean contratarServicio(String tipoContratacion,String tipoPromocion, int cantidadBotones,int cantidadCamaras,boolean tieneMovil,String calle,String numero) {
        boolean res = this.personaFisica.getFacturaDelMes().contratarServicio(tipoContratacion,tipoPromocion, cantidadBotones,cantidadCamaras,tieneMovil,calle,numero);
        if(res){
